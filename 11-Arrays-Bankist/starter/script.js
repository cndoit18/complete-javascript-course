...
function checkDogs(dogsJulia, dogsKate) {
  let reviseDogsJulia = dogsJulia.slice(1, -2);
  reviseDogsJulia.concat(dogsKate).forEach(function (year, i) {
    console.log(
      year >= 3
        ? `Dog number ${i + 1} is an adult, and is ${year} years old`
...
// #5
console.log(
  `${dogs.some(({ curFood, recommendedFood }) => curFood === recommendedFood)}`
);
...
// #8
console.log(
  dogs.slice().sort(({ recommendedFood: a }, { recommendedFood: b }) => a - b)
);
console.log(dogs);
